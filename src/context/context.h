...
class Context {
 ...
 private:
  Context()
      : main_strand_(main_context_),
        report_strand_(report_context_),
        main_work_(boost::asio::make_work_guard(main_context_)),
        report_work_(boost::asio::make_work_guard(report_context_)) {}
